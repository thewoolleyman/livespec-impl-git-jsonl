...
```
#!/usr/bin/env python3
"""Shebang wrapper for <cmd>. No logic; see livespec_orchestrator_git_jsonl.commands.<cmd>."""

from _bootstrap import bootstrap

bootstrap()

from livespec_orchestrator_git_jsonl.commands.<cmd> import main
...
`livespec_orchestrator_git_jsonl/migration/`.
